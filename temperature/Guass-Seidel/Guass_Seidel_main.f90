...
! Guass-Seidel_main.f90

program Guass_Seidel_main
    implicit none
    ...
    write (*,"('Solving Laplace equation on',i4,' by',i4,' grid by Guass-Seidel iteration')") n,n
    ...
    nthreads = 1
    call Guass_Seidel_sub(n, tol, maxiter, iter, dumax, nthreads)

    nthreads = 2
    call Guass_Seidel_sub(n, tol, maxiter, iter, dumax, nthreads)


end program Guass_Seidel_main
