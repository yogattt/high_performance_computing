...
subroutine SOR_sub(n, tol, maxiter, iter, dumax, nthreads)
...
do j=0,n+1
    ...
    do iter=1,maxiter
        ...
        do j=1,n
            do i=1,n
                u(i,j) = (1.0d0-w/10.0d0)*uold(i,j)+w/10.0d0*0.25d0*(uold(i-1,j) + uold(i+1,j) + &
